    ...
    <section id="intro">
        <div className="introsection">
            ...
            <div className='btnlinks'>  
              <a href="https://drive.google.com/file/d/1yPRx8zzpozb5iyDwFJk5nZpns4mnKN_X/view?usp=sharing" className='alink' target="_blank" rel="noopener noreferrer" ><img src={download} alt="resume" className='aimg'></img><span className='atext'>Resume</span></a>
